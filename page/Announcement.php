<section class="toside--h">
    ...
    <div class="subj-h subj-view">
        ...
        <form name="Announcements" class="contact" method="POST" action="./php-script/announcements.php">
            <!--  -->
            ...
            <div class="input-wrapper">
                ...
                <textarea rows="8" type="text" placeholder="holder" name="detail"></textarea>
            </div>
